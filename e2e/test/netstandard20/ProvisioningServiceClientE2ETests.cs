...
namespace Microsoft.Azure.Devices.E2ETests
{
    ...
    public class ProvisioningServiceClientE2ETests : IDisposable
    {
        ...
        private static readonly string IdPrefix = $"E2E_{nameof(ProvisioningServiceClientE2ETests)}_";
        ...
        {
            string groupId = IdPrefix + AttestationTypeToString(attestationType) + "_" + Guid.NewGuid();
            using (ProvisioningServiceClient provisioningServiceClient = CreateProvisioningService(proxyServerAddress))
            {
        ...
        {
            string registrationId = AttestationTypeToString(attestationType) + "_RegistrationId_" + Guid.NewGuid();
